...
<div class="container-fluid">
	...
	<div class="navbar-right">Welcome, '.$_SESSION['user']['uname'].' <a href="/index.php"><button class="btn btn-success ml-3 btn-sm">Logout</button></a></div>
</div></div>';
}
function t_sidebar() {
...
<div class="footer">
	<div class="row p-4">
		<div class="col-md-4">Provides student a pass for their daily life to travel to/from SLTC Reaserch University<br/>© 2015-2019 BTBS · All Rights Reserved</div>
		...
		<ul class="list-null">
            <li><a target="_blank" href="//https://www.facebook.com/SLTC.University//#"><i class="fa fa-facebook"></i></a></li>
            <li><a target="_blank" href="//https://www.instagram.com/sltcampus/?hl=en/#"><i class="fa fa-instagram"></i></a></li>
            <li><a target="_blank" href="//https://lk.linkedin.com/school/sri-lanka-technological-campus//#"><i class="fa fa-linkedin"></i></a></li>
            <li><a target="_blank" href="//https://twitter.com/slt_campus/#"><i class="fa fa-twitter"></i></a></li>
        </ul>
		</div>
	</div>
</div>
